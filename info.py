...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1002881371529 -1002503325544").split()
]
...
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1002498722116")
...
request_channel = environ.get("REQUEST_CHANNEL", "-1002498722116")
REQUEST_CHANNEL = (
    int(request_channel)
...
SHORTENER_API = environ.get("SHORTENER_API", "f454aa0a0473907a126cdc6763f5dc53361c1c7a")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "shortxlinks.com")
SHORTENER_API2 = environ.get(
    "SHORTENER_API2", "f454aa0a0473907a126cdc6763f5dc53361c1c7a"
)
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "shortxlinks.com")
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "f454aa0a0473907a126cdc6763f5dc53361c1c7a"
)
...
REFER_PICS = (environ.get("REFER_PICS", "https://files.catbox.moe/uhykxi.jpg")).split()
PAYPICS = (
    environ.get("PAYPICS", "https://files.catbox.moe/nj48eu.jpg")
).split()
SUBSCRIPTION = environ.get(
    "SUBSCRIPTION", "https://files.catbox.moe/uhykxi.jpg"
)
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
